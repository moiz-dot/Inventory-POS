        ...
        <div class="max-w-2xl space-y-6">
            ...
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-xl font-bold text-white tracking-tight">Barcode & QR Code Management</h2>
                </div>
                <p class="text-xs text-slate-500 font-mono mt-0.5">Direct character compilation of standard Code-128 patterns</p>
            </div>
            ...
            <div class="bg-slate-900/40 border border-slate-800/80 p-6 rounded-2xl space-y-6">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex items-center gap-2">
                            <button @click="count = Math.max(1, count - 1)" class="p-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white transition-colors">
                            ...
                            />
                            <button @click="count = Math.min(100, count + 1)" class="p-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white transition-colors">
                ...
                <button 
                    ...
                    class="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-xs text-white font-semibold rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-600/20"
                >
                ...
                <!-- Generated Barcode -->
                <div v-if="generated" class="border border-slate-800/80 bg-slate-950/50 p-6 rounded-xl flex flex-col items-center justify-center text-center space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div class="flex items-center gap-2 text-[9px] font-mono text-slate-500 uppercase">
                    ...
                    <div class="bg-white p-4 rounded-lg border-2 border-slate-200 dark:border-slate-700 flex flex-col items-center shadow-lg">
                        ...
                        <span class="text-slate-900 font-mono text-xs font-bold tracking-widest mt-3 pt-2 border-t border-slate-200 dark:border-slate-700 w-full text-center">
                            {{ activeProd.barcode }}
                        </span>
                    </div>

                    <!-- Details -->
                    <div class="grid grid-cols-2 gap-4 w-full text-xs font-mono text-slate-400">
                        <div class="bg-slate-900/50 p-2 rounded-lg text-center">
                            <p class="text-[8px] text-slate-500 uppercase">SKU Reference</p>
                            <p class="text-white font-bold text-sm">{{ activeProd.sku }}</p>
                        </div>
                        <div class="bg-slate-900/50 p-2 rounded-lg text-center">
                            <p class="text-[8px] text-slate-500 uppercase">Queue Position</p>
                    ...
                    <div class="flex gap-3 w-full">
                        <button class="flex-1 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-[10px] text-slate-300 hover:text-white rounded-lg transition-colors flex items-center justify-center gap-1.5">
            ...
            <!-- Quick Tips -->
            <div class="bg-slate-900/20 border border-slate-800/80 rounded-2xl p-4 flex items-start gap-3">
                <component :is="Info" class="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" />
                <div>
                    <p class="text-[10px] font-mono text-slate-400">
                        <span class="text-white font-semibold">Tip:</span> 
                    ...
                    <div class="flex gap-3 mt-1.5 text-[8px] font-mono text-slate-500">
            ...
            <div class="grid grid-cols-2 gap-3">
                <Link :href="route('dashboard.products')" class="p-3 bg-slate-900/30 border border-slate-800/80 rounded-xl text-center hover:border-slate-700/80 transition-all group">
                    ...
                    <span class="text-[9px] font-mono text-slate-400 group-hover:text-white transition-colors">View Products</span>
                </Link>
                <Link :href="route('dashboard.warehouses')" class="p-3 bg-slate-900/30 border border-slate-800/80 rounded-xl text-center hover:border-slate-700/80 transition-all group">
                    ...
                    <span class="text-[9px] font-mono text-slate-400 group-hover:text-white transition-colors">Print Queue</span>
                </Link>
            </div>
        </div>
    </AppLayout>
